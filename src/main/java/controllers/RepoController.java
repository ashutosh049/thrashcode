...
public class RepoController{
	...
	public ModelAndView repositories() throws IOException {
		...
		modelAndView.addObject("peak_repo", "repositories");
		...
		LinkedHashMap<ArticleCategories, List<Article>> articleCategoryArticlesMap= articleCategoriesDao.getAllArticleCategoryArticlesMap();
		modelAndView.addObject("articleCategoryArticlesMap",articleCategoryArticlesMap);
